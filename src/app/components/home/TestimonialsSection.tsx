          ...
          <div className="relative">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6">
                <div className="relative">
                  ...
                  <div className="absolute -bottom-2 -right-2 bg-[#E4835D] rounded-xl p-2 shadow-md">
                    <Quote className="h-4 w-4 text-[#ddb1eb]"/>
                  </div>
                </div>
                ...
                <div className="flex-1 text-center sm:text-left">
                  ...
                  <div className="flex justify-center sm:justify-start gap-1">
                    {[...Array(testimonials[currentIndex].rating)].map((_, i) => (
                      <Star key={i} className="h-5 w-5 fill-[#dbb1eb] text-[#dbb1eb]" />
                    ))}
                  </div>
                </div>
              </div>
            ...
            <div className="absolute top-1/2 -translate-y-1/2 -left-4 md:-left-16">
              <motion.button
                ...
                className="bg-white text-[#ddb1eb] p-4 rounded-full shadow-xl hover:shadow-2xl transition-all border-2 border-[#E4835D]/20"
              >
            ...
            {testimonials.map((_, index) => (
              <motion.button
                ...
                className={`h-3 rounded-full transition-all ${
                  index === currentIndex
                    ? 'w-12 bg-[#c993dd]'
                    : 'w-3 bg-[#E9d7f0]/30 hover:bg-[#ddb9eb]/50'
                }`}
              />
            ))}
          </div>
