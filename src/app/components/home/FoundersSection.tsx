...
const developers = [
  {
    ...
    image: 'https://i.pinimg.com/736x/e8/d9/5d/e8d95d762dfcf01b9d306259771e57d1.jpg',
  ...
  },
  {
    ...
    image: 'https://i.pinimg.com/736x/86/4a/34/864a343d28e812aa27cc1e85ee3eefd6.jpg',
    ...
    <section id="founders" className="py-20 bg-[#FDFBF7] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-[#583361] max-w-2xl mx-auto">
          ...
          <div className="bg-white p-2 rounded-full inline-flex gap-2 shadow-sm border border-[#E4835D]/10">
            <motion.button
              ...
              className={`px-6 py-3 rounded-full flex items-center gap-2 transition-all ${
                activeTab === 'creators'
                  ? 'bg-[#DAACEC] text-white shadow-md'
                  : 'text-[#6D524A] hover:bg-[#DAACEC]/10'
              }`}
            >
        ...
        {selectedPerson && (
          ...
          >
            ...
            >
              ...
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#DAACEC]/30 rounded-bl-[100px] -z-10" />
<div className="absolute bottom-0 left-0 w-24 h-24 bg-[#DAACEC]/30 rounded-tr-[80px] -z-10" />
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <motion.div 
                  ...
                  className="inline-block bg-[#DAACEC]/30 text-[#8E4FA7]"
                >
                  {selectedPerson.role}
                </motion.div>
