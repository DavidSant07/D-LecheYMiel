  ...
  return (
    <section className="py-24 bg-[#FDFBF7]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-[#CD94DE] mb-4">
              ...
              <div className="relative z-10 flex-1 flex flex-col justify-between p-6 md:p-8 md:pl-2">
                ...
                <div className="flex justify-end mt-auto pt-4">
                  <button 
                    ...
                    className="flex items-center justify-center gap-3 px-8 py-3 rounded-full border-2 border-[#E4835D] text-[#E4835D] font-medium group-hover:bg-[#DAACEC] group-hover:text-white transition-all duration-300"
                  >
                    Ver detalle
        ...
        >
          <motion.button
            ...
            className="bg-[#E3BDF2] text-white px-8 py-4 rounded-full hover:bg-[#B670D2] transition-colors shadow-lg font-medium"
          >
