      ...
      <div className="min-h-screen bg-[#FDFBF7] flex items-center justify-center py-20">
        ...
        >
          ...
          <motion.button
            ...
            className="bg-[#DAACEC] text-white px-8 py-4 rounded-full hover:bg-[#6D524A] transition-colors shadow-lg"
          >
            Ver Productos
          </motion.button>
        </motion.div>
          ...
          <div className="lg:col-span-1">
            ...
            >
              ...
              <motion.button
                ...
                className="w-full bg-[#e0b6f1] text-white py-4 rounded-full flex items-center justify-center gap-2 hover:bg-[#6D524A] transition-colors shadow-lg hover:shadow-xl font-semibold text-lg"
              >
                Confirmar Pedido
