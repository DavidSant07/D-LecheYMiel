...
export function ProductsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FFFFFFF2] py-12">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="md:hidden flex items-center gap-2 text-[#E7C7FC]"
            >
  ...
  selectedCategory === category
    ? 'bg-[#C993DD] text-white shadow-lg'
    : 'bg-[#E9D8F0] text-[#6D524A] hover:bg-[#e0b6f1] border border-[#DAACEC]/20'
}`}
                >
                  {category}
                </motion.button>
              ...
              <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                <div className="relative aspect-square overflow-hidden">
                  ...
                  {product.allergens.nuts && (
                    <div className="absolute top-4 left-4 bg-[#9BBFF1] text-white px-3 py-1 rounded-full text-xs font-medium">
                      Contiene nueces
                    </div>
                  )}
                </div>
                ...
                <div className="p-6">
                  ...
                  <motion.button
                    ...
                    className="w-full bg-[#DAACEC] text-white py-3 rounded-full flex items-center justify-center gap-2 hover:bg-[#6D524A] transition-colors"
                  >
